...
import br.ufes.inf.nemo.ufo.protege.pattern.relations.ComparativeRelationCommand;
 ...
 * @author jeferson
 */
public class ComparativeRelationPatternFrame extends JFrame implements ActionListener {
    
    private final ComparativeRelationCommand command;
    
    private JComboBox relationTypeSelection;
    private JComboBox subjectSelection;
    private JComboBox objectSelection;
    
    private final JLabel relationTypeLabel = new JLabel("Comparative relation type: ");
    ...
    public ComparativeRelationPatternFrame(ComparativeRelationCommand command) {
        
        this.command = command;
        
        this.setTitle("New comparative relation");
    ...
    public void setComparedIRIs(List<IRI> IRIs) {
        this.comparedIRIs = IRIs;
    }
        ...
        try {
            switch (action) {
                case "OK":
                    ...
                    subject = comparedIRIs.get(index);
                    
                    index = objectSelection.getSelectedIndex();
                    object = comparedIRIs.get(index);
