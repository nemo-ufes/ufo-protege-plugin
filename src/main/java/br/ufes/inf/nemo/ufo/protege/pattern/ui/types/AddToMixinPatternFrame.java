...
import br.ufes.inf.nemo.ufo.protege.pattern.types.AddToMixinCommand;
 ...
 * @author jeferson
 */
public class AddToMixinPatternFrame extends JFrame implements ActionListener {
    
    private final AddToMixinCommand command;
    
    private JComboBox mixinSelection;
    private JComboBox endurantTypeSelection;
    
    private final JLabel mixinLabel = new JLabel("Mixin: ");
    private final JLabel endurantTypeLabel = new JLabel("Endurant type to be added: ");
    ...
    public AddToMixinPatternFrame(AddToMixinCommand command) {
        
        this.command = command;
        
        this.setTitle("Add to mixin");
